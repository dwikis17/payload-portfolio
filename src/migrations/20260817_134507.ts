...
import { seedCategories } from '../seed/portfolio'
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "users_id", "media_id", "projects_id", "experiences_id", "posts_id") SELECT "id", "order", "parent_id", "path", "users_id", "media_id", "projects_id", "experiences_id", "posts_id" FROM \`payload_locked_documents_rels\`;`)
